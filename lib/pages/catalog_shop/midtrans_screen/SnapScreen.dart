  ...
  List<String> getResult() {
    String title = '', desc = '';
      ...
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_300:
        title = 'Some specific message for status code 300';
        desc = 'Description for status code 300';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_400:
        title = 'Some specific message for status code 400';
        desc = 'Description for status code 400';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_401:
        title = 'Some specific message for status code 401';
        desc = 'Description for status code 401';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_402:
        title = 'Some specific message for status code 402';
        desc = 'Description for status code 402';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_403:
        title = 'Some specific message for status code 403';
        desc = 'Description for status code 403';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_404:
        title = 'Some specific message for status code 404';
        desc = 'Description for status code 404';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_405:
        title = 'Some specific message for status code 405';
        desc = 'Description for status code 405';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_406:
        title = 'Some specific message for status code 406';
        desc = 'Description for status code 406';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_407:
        title = 'Some specific message for status code 407';
        desc = 'Description for status code 407';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_408:
        title = 'Some specific message for status code 408';
        desc = 'Description for status code 408';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_409:
        title = 'Some specific message for status code 409';
        desc = 'Description for status code 409';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_410:
        title = 'Some specific message for status code 410';
        desc = 'Description for status code 410';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_411:
        title = 'Some specific message for status code 411';
        desc = 'Description for status code 411';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_412:
        title = 'Some specific message for status code 412';
        desc = 'Description for status code 412';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_413:
        title = 'Some specific message for status code 413';
        desc = 'Description for status code 413';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_500:
        title = 'Some specific message for status code 500';
        desc = 'Description for status code 500';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_501:
        title = 'Some specific message for status code 501';
        desc = 'Description for status code 501';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_502:
        title = 'Some specific message for status code 502';
        desc = 'Description for status code 502';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_503:
        title = 'Some specific message for status code 503';
        desc = 'Description for status code 503';
        break;
      case MIDTRANS_STATUS_CODE.MIDTRANS_STATUS_CODE_504:
        title = 'Some specific message for status code 504';
        desc = 'Description for status code 504';
        break;
        case null:
          title = 'Status Code is null';
          desc = 'Description for null status code';
          break;
    }
    return [title,desc];
  }
